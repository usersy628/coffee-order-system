...
| [`S9-01`](https://github.com/usersy628/coffee-order-system/issues/6) | `DONE` | `S8-01` | Outbox 게시자와 Mock 데이터 수집 플랫폼 | V3 수신 저장, claim·lease·fencing·6회 재시도, 실제 HTTP 취소와 중복 제거 검증 성공; PR 검토 대기 |
