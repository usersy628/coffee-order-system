...
| [`S6-02`](https://github.com/usersy628/coffee-order-system/issues/22) | `IN_PROGRESS` | `S6-01`, `S5-04` | 메뉴 UTC 시간 매핑과 README 구현 상태 정합성 보완 | MySQL `DATETIME(6)`·`Instant` 정밀도 테스트와 문서 정합성 검증 성공 |
