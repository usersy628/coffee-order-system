...
| [S14-01](https://github.com/usersy628/coffee-order-system/issues/11) | IN_PROGRESS | S6-01, S7-01, S8-01, S9-01, S10-01, S11-01, S12-01 | 구현 중 수시 기록한 내용을 정리한 TIL 트러블슈팅 문서 | 문제·원인·해결·검증 근거가 기록됨 |
...
현재 IN_PROGRESS 작업은 S14-01 하나다. DOC-02, S11-01, S12-01과 S13-01의 계획·구현·검증 상세는 [IMPLEMENTATION_RECORDS.md](IMPLEMENTATION_RECORDS.md)에 보존한다. 다음 기능 작업을 시작하기 전에는 연결한 GitHub PR의 라이브 상태를 확인한다.
